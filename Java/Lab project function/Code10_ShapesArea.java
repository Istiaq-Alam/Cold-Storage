...
public class Code10_ShapesArea {
    public static void main(String[] args) {
        ...
        switch (shape) {
            ...
            case 3:
                ...
                area = RactangleArea(length, width);
                System.out.println("Area of Rectangle is:" + area);
                break;
            case 4:
                System.out.print("\tArea of Square\nEnter the length of Squre:");
                length = input.nextDouble();
                area = SqureArea(length);
            ...
            case 6:
                ...
                area = trapeziumArea(side1, side2, height);
    ...
    public static double RactangleArea(double length, double width) {
        // Area = length*width;
        double area = length * width;
        return area;
    }

    public static double SqureArea(double length) {
    ...
    public static double trapeziumArea(double side1, double side2, double height) {
